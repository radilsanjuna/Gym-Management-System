...
<body>
    <div class="container mt-5">
        ...
        <h2 class="text-center mt-5">Gym Classes</h2>
        <div class="row">
                    ...
                    <div class="col-md-4 mb-4">
                        <div class="card h-100">
                            <div class="card-body">
                                ...
                                <a href="edit_class.php?id=<?php echo $row['id']; ?>" class="btn btn-warning w-100 mb-2">Edit</a>
                                <a href="delete_class.php?id=<?php echo $row['id']; ?>" class="btn btn-danger w-100" onclick="return confirm('Are you sure you want to delete this class?');">Delete</a>
                            </div>
                        </div>
                    </div>
                <?php endwhile; ?>
            <?php else: ?>
                <div class="alert alert-info w-100 text-center" role="alert">No gym classes found.</div>
            <?php endif; ?>
        </div>
    </div>
